# a.08.76.Udev.from.Systemd-257.3.sh
#

export PKG="systemd-257.3"
...
sed     -e '/systemd-sysctl/s/^/#/'             \
        -i rules.d/99-systemd.rules.in          \
        >> $PKGLOG_OTHERS 2>> $PKGLOG_ERROR
...
tar -xvf ../../systemd-man-pages-257.3.tar.xz                           \
