# a.08.51.Python-3.11.13.sh
# latest 2025/Jun/13
#

export PKG="Python-3.11.13"
...
install -v -dm755 /usr/share/doc/python-3.11.13/html    \
    >> $PKGLOG_OTHERS 2>> $PKGLOG_ERROR

tar --strip-components=1                        \
    --no-same-owner                             \
    --no-same-permissions                       \
    -C /usr/share/doc/python-3.11.13/html       \
    -xvf ../python-3.11.13-docs-html.tar.bz2    \
