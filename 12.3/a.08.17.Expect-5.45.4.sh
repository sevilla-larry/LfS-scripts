...
echo "   inside the chroot environment by performing a simple test..."          >> $LFSLOG_PROCESS
echo "   inside the chroot environment by performing a simple test..."          >> $PKGLOG_ERROR
