...
echo "08.91.50.04.Test-Warnings-0.038"
echo "08.91.50.04.Test-Warnings-0.038" >> $LFSLOG_PROCESS

time { bash a.08.91.50.04.Test-Warnings-0.038.sh ; }
...
echo "08.91.50.05.Test-Needs-0.002010"
echo "08.91.50.05.Test-Needs-0.002010" >> $LFSLOG_PROCESS

time { bash a.08.91.50.05.Test-Needs-0.002010.sh ; }
