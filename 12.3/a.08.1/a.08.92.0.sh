...
echo "08.92.11.Sudo-1.9.16p2"
echo "08.92.11.Sudo-1.9.16p2" >> $LFSLOG_PROCESS

time { bash a.08.92.11.Sudo-1.9.16p2.sh ; }
...
echo "08.92.13.Libcap-2.73.with.PAM"
echo "08.92.13.Libcap-2.73.with.PAM" >> $LFSLOG_PROCESS

time { bash a.08.92.13.Libcap-2.73.with.PAM.sh ; }
