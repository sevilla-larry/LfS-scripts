...
echo "05.02.Binutils-2.42-Pass1"
echo "05.02.Binutils-2.42-Pass1" >> $LFSLOG_PROCESS

time { bash a.05.02.Binutils-2.42-Pass1.sh ; }
...
echo "05.04.Linux-6.7.4.API.Headers"
echo "05.04.Linux-6.7.4.API.Headers" >> $LFSLOG_PROCESS

time { bash a.05.04.Linux-6.7.4.API.Headers.sh ; }
