...
echo "   Fix a security vulnerability in the split utility..."
echo "   Fix a security vulnerability in the split utility..." >> $LFSLOG_PROCESS
echo "   Fix a security vulnerability in the split utility..." >> $PKGLOG_ERROR
...
#
# two test named test-getlogin and test/tty/tty.sh are known to fail
