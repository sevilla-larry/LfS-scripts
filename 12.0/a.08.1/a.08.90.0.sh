...
echo "08.90.2.efivar-38"
echo "08.90.2.efivar-38" >> $LFSLOG_PROCESS

time { bash a.08.90.2.efivar-38.sh ; }
...
echo "08.90.4.GRUB-2.06.for.EFI.x64"
echo "08.90.4.GRUB-2.06.for.EFI.x64" >> $LFSLOG_PROCESS

time { bash a.08.90.4.GRUB-2.06.for.EFI.x64.sh ; }
